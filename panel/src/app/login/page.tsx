    ...
    <form onSubmit={handleLogin} style={{
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '10px 12px', background: '#09090b', border: '1px solid #27272a', borderRadius: 8, color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box' }}
        />
      </div>
      ...
      {error && (
        <div style={{ background: '#3f1212', border: '1px solid #7f1d1d', borderRadius: 8, padding: '10px 14px', color: '#fca5a5', fontSize: 13, marginBottom: 16 }}>
          {error}
        </div>
      )}
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        {/* Form envuelto en Suspense para useSearchParams */}
        <Suspense fallback={
          <div style={{ background: '#18181b', border: '1px solid #27272a', borderRadius: 16, padding: 28, textAlign: 'center', color: '#52525b' }}>
            Cargando...
          </div>
        }>
          <LoginForm />
